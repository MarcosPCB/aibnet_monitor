...
function listBBrands() {
  return _listBBrands.apply(this, arguments);
}
function _listBBrands() {
  _listBBrands = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var token, response, options, brands, i;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          _context.next = 4;
          return window.axios.get(globals.api_url + "brand/list", {
            headers: {
              'Authorization': 'Bearer ' + token,
              'Content-Type': 'application/json',
              'Accept': 'application/json'
        ...
        case 14:
          ...
          alert('Erro ao listar marcas:', _context.t0);
          checkAuth(_context.t0.response);
        case 18:
        case "end":
...
function getBBrand() {
  return _getBBrand.apply(this, arguments);
}
function _getBBrand() {
  _getBBrand = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var token, response;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.prev = 1;
          _context2.next = 4;
          return window.axios.get(globals.api_url + "brand/".concat(globals.brand_id), {
            headers: {
              'Authorization': 'Bearer ' + token,
              'Content-Type': 'application/json',
              'Accept': 'application/json'
        ...
        case 10:
          ...
          alert('Erro ao buscar marca:', _context2.t0);
...
function editPrimaryBrand(_x) {
  return _editPrimaryBrand.apply(this, arguments);
}
function _editPrimaryBrand() {
  _editPrimaryBrand = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(event) {
    var brand;
...
var _require4 = __webpack_require__(/*! ./brand */ "./resources/js/funcs/brand.js"),
  listBBrands = _require4.listBBrands;
function listBrands() {
  var token = readCookie('token');
...
function fillEditOpponents() {
  var token = readCookie('token');
  window.axios.get(globals.api_url + "main-brand/".concat(globals.main_brand_id, "/").concat(globals.account_id), {
    headers: {
      'Authorization': 'Bearer ' + token,
      'Content-Type': 'application/json',
      'Accept': 'application/json'
    ...
    var mb = response.data;
    $('#edit_main_brand_name_id').val(mb.mainBrand.name);
    $('#edit_main_brand_model_id').val(mb.mainBrand.chat_model);
    var primary = $('#edit_main_brand_primary_id')[0];
    primary.innerHTML = '';
    var elementPrimary = $("<li class=\"list-group-item d-flex align-items-center data-api-id=".concat(mb.primary.id, "\">\n                <span class=\"me-auto\">Marca ").concat(mb.primary.id, ": ").concat(mb.primary.name, "</span>\n                <span class=\"btn btn-icon edit-btn text-white\">\n                    <i class=\"fa-solid fa-pen-to-square\"></i>\n                </span>\n            </li>"));
    elementPrimary.find('.edit-btn').on('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
    ...
    var list = $('#edit_main_brand_opponents_id')[0];
    list.innerHTML = '';
    var _loop = function _loop(i) {
      var e = mb.opponents[i];
      var element = $("<li class=\"list-group-item d-flex align-items-center data-api-id=".concat(e.id, "\">\n                    <span class=\"me-auto\">Marca ").concat(e.id, ": ").concat(e.name, "</span>\n                    <span class=\"btn btn-icon edit-btn text-white\">\n                        <i class=\"fa-solid fa-pen-to-square\"></i>\n                    </span>\n                    <span class=\"btn btn-icon delete-btn text-white\">\n                        <i class=\"fa-solid fa-trash-can-xmark\"></i>\n                    </span>\n                </li>"));
      element.find('.edit-btn').on('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
      ...
      if (i > 1) {
        element.find('.delete-btn').on('click', function () {
          var r = confirm('Deseja mesmo excluir este concorrente?');
          if (r) {
    ...
    for (var i = 0; i < mb.opponents.length; i++) {
      _loop(i);
    }
  })["catch"](function (e) {
    console.error('Erro ao listar marcas:', e);
...
function editMainBrandBrands(_x) {
  return _editMainBrandBrands.apply(this, arguments);
}
function _editMainBrandBrands() {
  _editMainBrandBrands = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(event) {
    var token, brand_id, response, mb, detach, _detach, result, _result;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _detach = function _detach3() {
            _detach = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
              var _response;
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    _context3.prev = 0;
                    _context3.next = 3;
                    return window.axios.patch(globals.api_url + "main-brand/detach/".concat(globals.main_brand_id, "/").concat(globals.account_id), {
                      brand_id: id
                    }, {
                      headers: {
                        'Authorization': 'Bearer ' + token,
                  ...
                  case 9:
                    ...
                    alert("Erro ao retirar marca ".concat(id, " do cliente"));
                    checkAuth(_context3.t0);
          ...
          detach = function _detach2(_x2) {
            return _detach.apply(this, arguments);
          };
          token = readCookie('token');
          brand_id = $('#select_edit_brand_id').val();
          changeToLoad(event.currentTarget);
          _context4.next = 7;
          return window.axios.get(globals.api_url + "main-brand/".concat(globals.main_brand_id, "/").concat(globals.account_id), {
            headers: {
              'Authorization': 'Bearer ' + token,
              'Content-Type': 'application/json',
              'Accept': 'application/json'
        ...
        case 18:
          _context4.next = 20;
          return detach(mb.opponents[globals.selected_edit_brand - 1]);
        case 20:
        ...
        case 24:
          _context4.prev = 24;
          _context4.next = 27;
          return window.axios.patch(globals.api_url + "main-brand/attach/".concat(globals.main_brand_id, "/").concat(globals.account_id), {
            brand_id: brand_id,
...
function listPlatforms() {
  ...
  window.axios.get(globals.api_url + "brand/list/platforms/".concat(globals.brand_id), {
    ...
    response.data.forEach(function (e) {
      ...
      element.find('.edit-btn').on('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var platform;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
...
function _getPlatform() {
  _getPlatform = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var token, response;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.prev = 1;
          _context2.next = 4;
          return window.axios.get(globals.api_url + "platform/".concat(globals.platform_id), {
            headers: {
              'Authorization': 'Bearer ' + token,
              'Content-Type': 'application/json',
              'Accept': 'application/json'
        ...
        case 10:
          _context2.prev = 10;
          _context2.t0 = _context2["catch"](1);
          alert('Erro ao buscar plataforma:', _context2.t0);
          checkAuth(_context2.t0.response);
          return _context2.abrupt("return", null);
        case 15:
        case "end":
...
function savePlatform(event) {
  var name = $('#edit_platform_name_id').val();
  var type = $('#edit_platform_type_id').val();
  var url = $('#edit_platform_url_id').val();
  var new_platform_id = $('#edit_platform_id_id').val();
  var active = $('#edit_platform_active_id').prop('checked');
  var token = readCookie('token');
  changeToLoad(event.currentTarget);
  window.axios.patch(globals.api_url + "platform/update/".concat(globals.platform_id), {
    name: name,
    url: url,
    type: type,
...
$(document).ready(function () {
  ...
  $('#edit_main_brand_config_btn_id').click(function () {
    fillEditOpponents();
  ...
  $(document).on('shown.bs.modal', function (e) {
    ...
    if (modalId == 'create_main_brand_modal_id') {
      listBBrands();
      var pBrand = $('#new_main_brand_primary_id').val();
      if (!pBrand) $('#edit_primary_brand_btn_id')[0].classList.add('disabled_btn');else $('#edit_primary_brand_btn_id')[0].classList.remove('disabled_btn');
      var oBrand1 = $('#new_main_brand_opponent_1_id').val();
      if (oBrand1 == -1) $('#edit_opponent_1_brand_btn_id')[0].classList.add('disabled_btn');else $('#edit_opponent_1_brand_btn_id')[0].classList.remove('disabled_btn');
      var oBrand2 = $('#new_main_brand_opponent_2_id').val();
      if (oBrand2 == -1) $('#edit_opponent_2_brand_btn_id')[0].classList.add('disabled_btn');else $('#edit_opponent_2_brand_btn_id')[0].classList.remove('disabled_btn');
    }
  });
  ...
  $('#new_main_brand_opponent_1_id').on('change', function () {
    // A função será executada quando o valor do select mudar
    var oBrand = $(this).val();
    if (oBrand == -1) $('#edit_opponent_1_brand_btn_id')[0].classList.add('disabled_btn');else $('#edit_opponent_1_brand_btn_id')[0].classList.remove('disabled_btn');
  });
  $('#new_main_brand_opponent_2_id').on('change', function () {
    // A função será executada quando o valor do select mudar
    var oBrand = $(this).val();
    if (oBrand == -1) $('#edit_opponent_2_brand_btn_id')[0].classList.add('disabled_btn');else $('#edit_opponent_2_brand_btn_id')[0].classList.remove('disabled_btn');
  });
  ...
  var token = readCookie('token');
  window.axios.get(globals.api_url + "check-token/".concat(globals.account_id), {
    headers: {
      'Authorization': 'Bearer ' + token,
      'Content-Type': 'application/json',
      'Accept': 'application/json'

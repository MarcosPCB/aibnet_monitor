...
function _getBBrand() {
  _getBBrand = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var token, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 10:
          ...
          alert('Erro ao buscar marca:', _context.t0);
...
function _editPrimaryBrand() {
  _editPrimaryBrand = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
    var brand;
